...
files_array=("main.c"
             ...
             "fundamental_functions/game_functions/debug_game_functions/debug_functions.c"
             "fundamental_functions/game_functions/management/game_management.c"
             "fundamental_functions/game_functions/Logic/calculus_functions.c"
             "fundamental_functions/game_functions/Logic/logic_functions.c"
             "fundamental_functions/game_functions/play_back/play_back_game_functions.c"
             "fundamental_functions/affichage/affichage.c"
